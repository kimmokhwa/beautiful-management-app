            ...
            <TableBody>
              {topMarginProcedures.map((procedure, index) => (
                <TableRow key={procedure.id}>
                  ...
                  <TableCell>{(procedure.price || 0).toLocaleString()}원</TableCell>
                  ...
                  <React.Fragment key={procedure.id}>
                    <ListItem sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                      <ListItemText
                        ...
                        secondary={`마진율: ${procedure.margin_rate}% (고객가: ${(procedure.price || 0).toLocaleString()}원)`}
                      />
                      <TextField
                        label="목표 판매량"
                        type="number"
                ...
                {topProcedures.map((procedure, index) => (
                  <React.Fragment key={procedure.id}>
                    <ListItem>
                      <ListItemText
                        primary={procedure.name}
                        secondary={`${(procedure.price || 0).toLocaleString()}원 (마진율: ${procedure.margin_rate}%)`}
                      />
                    </ListItem>
                  ...
                  <React.Fragment key={material.id}>
                    <ListItem>
                      <ListItemText
                        ...
                        secondary={`${(material.price || 0).toLocaleString()}원`}
                      />
                    </ListItem>
