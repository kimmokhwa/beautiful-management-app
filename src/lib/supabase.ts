...
// Supabase 프로젝트 설정
const supabaseUrl = 'https://egbvvxmnvxqkewuyjzbt.supabase.co';
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImVnYnZ2eG1udnhxa2V3dXlqemJ0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTM4NTczNjIsImV4cCI6MjA2OTQzMzM2Mn0.59PP9ULhY3PHqLEB_F_fcXR0MIwCxYp6dg4wOziiaQ8';
